...
[mukhxadnahunna.com/php/contributing](https://mukhxadnahunna.com/php/contributing).

## Reporting a problem

Open an issue in this repository:
[github.com/PG-Momik/no-nepali-profanity-php/issues](https://github.com/PG-Momik/no-nepali-profanity-php/issues). Include:

- the **exact input text**,
- which words were found, and what you expected,
- that you used the PHP package, and the options you passed, if any.
...
`src/Lexicon.php` holds the word lists, `src/ProfanityFilter.php` the matching logic and `src/Profanity.php` the static facade.
...
- Add a test to `tests/ProfanityTest.php`: a "catches" case for something that should be flagged, and a "does not flag" case for a
